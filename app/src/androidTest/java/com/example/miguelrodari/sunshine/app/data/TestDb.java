...
public class TestDb extends AndroidTestCase {
    ...
    void deleteTheDatabase() {
        mContext.deleteDatabase(com.example.miguelrodari.sunshine.app.data.WeatherDbHelper.DATABASE_NAME);
    }
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        ContentValues contentValues = TestUtilities.createWeatherValues(location_id);
        // Insert ContentValues into database and get a row ID back
        long weather_id = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, contentValues);
