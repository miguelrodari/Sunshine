...
public class SettingsActivity extends PreferenceActivity
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if (preference instanceof ListPreference) {
            ...
            if(preference.equals(findPreference(getString(R.string.pref_local_key)))){
//                String mLoc = ((ListPreference) preference).getValue();
//                if(mLoc != this.getResources().getConfiguration().locale.getLanguage()){
//                    Locale loc = new Locale(mLoc);
