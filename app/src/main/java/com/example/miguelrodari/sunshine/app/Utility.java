...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        ...
        return prefs.getString(context.getString(R.string.pref_temp_key),
                context.getString(R.string.temp_unit_imperial))
                .equals(context.getString(R.string.temp_unit_metric));
    }
    ...
    public static boolean displayNotifications(Context context){
        ...
        return prefs.getBoolean(displayNotificationsKey, Boolean.parseBoolean(context.getString(R.string.pref_notification_default)));
    }
    ...
    public static String getFormattedMonthDay(Context context, long dateInMillis ) {
        ...
        Locale locale = context.getResources().getConfiguration().locale;
        SimpleDateFormat monthDayFormat = new SimpleDateFormat("MMMM dd", locale);
