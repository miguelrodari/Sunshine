package com.example.miguelrodari.sunshine.app.sync;
...
import com.example.miguelrodari.sunshine.app.MainActivity;
import com.example.miguelrodari.sunshine.app.R;
import com.example.miguelrodari.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(LOCAL_PARAM, locale)
                    .build();
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = getContext().getContentResolver().query(
                locationUri, projection, selection, selectionArgs, null);
        if (locationCursor.moveToFirst()){
            ...
            Uri insertedUri = getContext().getContentResolver().insert(locationUri, locationValues);
    ...
    private void notifyWeather() {
        ...
        if ((System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) && Utility.displayNotifications(context)) {
